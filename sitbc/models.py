...
class KabupatenKota(models.Model):
    ...
    jml_rs = models.IntegerField(verbose_name="Jml RS", default=0)
    jml_pkm = models.IntegerField(verbose_name="Jml PKM", default=0)
    jml_klinik = models.IntegerField(default=0)
    jml_dpm = models.IntegerField(verbose_name="Jml DPM", default=0)
    jml_balai = models.IntegerField(default=0)
    jml_lab = models.IntegerField(default=0)
    link_idcf = models.TextField(verbose_name="Link IDCF", null=True, blank=True)
    pj = models.CharField(verbose_name="Penanggung jawab", max_length=150, blank=True)
