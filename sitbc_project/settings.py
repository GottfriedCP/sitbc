"""
Django settings for sitbc_project project.
...
ROOT_URLCONF = "sitbc_project.urls"
...
WSGI_APPLICATION = "sitbc_project.wsgi.application"
...
CSRF_TRUSTED_ORIGINS = config("CSRF_HOSTS", cast=Csv())
